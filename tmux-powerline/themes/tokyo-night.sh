...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-$TOKYO_NIGHT_DARK}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-$TOKYO_NIGHT_BLUE}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info ${TOKYO_NIGHT_LIGHT_BLUE} ${TOKYO_NIGHT_BLUE}"
		# "hostname 33 0"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		#"earthquake 3 0"
        "pwd ${TOKYO_NIGHT_DARK} ${TOKYO_NIGHT_TEXT} default_separator ${TOKYO_NIGHT_DARK}"
		...
		#"xkb_layout 125 117"
		# "date_day 235 136"
        "time ${TOKYO_NIGHT_LIGHT_BLUE} ${TOKYO_NIGHT_BLUE}"
        "date ${TOKYO_NIGHT_BLUE} ${TOKYO_NIGHT_DARK} ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD}"
